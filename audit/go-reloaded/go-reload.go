...
// 					}
// 				}
// 			} else if apostrophes%2 == 1 {
// 				if formatted[i] == '\'' {
// 					fmt.Println(i)
// 					apostrophes++
// 					if formatted[i-1] == ' ' {
// 						formatted2 = formatted2[:len(formatted2)-1]
// 						formatted2 += "'"
// 						continue
// 					}
// 				}
...
// 		if formatted2[i] == '(' {
// 			openBrackets++
// 		} else if formatted2[i] == ')' {
// 			openBrackets--
// 		} else {
// 			if openBrackets == 0 {
// 				if i == len(formatted2)-1 {
// 					formatted3 += string(formatted2[i])
// 					continue
// 				}
// 				if formatted2[i+1] == '(' && formatted2[i] == ' ' {
// 					continue
// 				}
// 				formatted3 += string(formatted2[i])
// 			}
